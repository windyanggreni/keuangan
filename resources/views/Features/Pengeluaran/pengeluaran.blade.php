...
<div class="alert alert-danger">
    <strong>Rata-rata Pengeluaran Harian (30 Hari Terakhir):</strong> Rp {{ number_format($averageDailyExpense, 0, ',', '.') }}
</div>

@if($largestExpense)
    <div class="alert alert-info">
        <strong>Pengeluaran Terbesar:</strong> Rp {{ number_format($largestExpense->jumlah, 0, ',', '.') }}
        untuk kategori {{ $largestExpense->kategori->kategori_pengeluaran }} pada {{ \Carbon\Carbon::parse($largestExpense->tanggal)->format('d M Y') }}.
    </div>
@endif
